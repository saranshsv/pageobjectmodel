...
public class CustomListeners extends Page implements ITestListener, ISuiteListener {
	 ...
	 * }
	 * 
	 * @Override public void onFinish(ISuite suite) { MonitoringMail mail=new
	 * MonitoringMail();
	 * 
	 * try { messageBody = "http://"+InetAddress.getLocalHost().getHostAddress()+
	 * ":8080/job/DataDrivenLiveProject/Extent_20Report/"; } catch
	 * (UnknownHostException e) { // TODO Auto-generated catch block
	 * e.printStackTrace(); } System.out.println(messageBody); try {
